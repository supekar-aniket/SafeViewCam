				...
				<div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
					<div class="position-relative h-100">
						<img class="position-absolute w-100 h-100 rounded wow zoomIn"
							data-wow-delay="0.3s" src="img/about.jpg"
				...
				<div class="col-lg-7">
					<div class="mb-4">
						<h5 class="text-primary text-uppercase"
							style="letter-spacing: 5px;">Our Story</h5>
						<h1 class="display-5 mb-0">Providing High-Quality CCTV
							Systems & Services</h1>
					</div>
					<h4 class="text-body fst-italic mb-4">Your Trusted Source for High-Quality CCTV Systems & Services.</h4>
					<p class="mb-4">Welcome to SafeViewCam, your unwavering ally in securing what matters most. As a premier provider of high-quality CCTV systems and services, we stand as a beacon of reliability and excellence in the realm of security technology.</p>
					<div class="row g-3">
						<div class="col-sm-6 wow zoomIn" data-wow-delay="0.6s">
							<div
								...
								<h4 class="text-white mb-0">Over 3 Years of Experience</h4>
							</div>
						</div>
						<div class="col-sm-6 wow zoomIn" data-wow-delay="0.9s">
							<div
								...
								<h4 class="text-white mb-0">Proudly Award Winning</h4>
							</div>
						</div>
					</div>
				</div>
